...
let
  ...
  desiredFlatpaks = [
    ...
    "launcher.moe moe.launcher.the-honkers-railway-launcher"
    "org.upscayl.Upscayl"
  ];
in {
  system.userActivationScripts.flatpakManagement = {
    text = ''
      ...
      ${pkgs.flatpak}/bin/flatpak remote-add --if-not-exists launcher.moe \
        https://gol.launcher.moe/gol.launcher.moe.flatpakrepo
